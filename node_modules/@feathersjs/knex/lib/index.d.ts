...
export declare class KnexService<T = any, D = Partial<T>, P extends Params<any> = KnexAdapterParams> extends KnexAdapter<T, D, P> implements ServiceMethods<T | Paginated<T>, D, P> {
    find(params?: P & {
