...
const productModifierServiceMethods = ['find', 'get', 'create', 'update', 'patch', 'remove'];
const shipdayServiceMethods = ['find', 'get', 'create', 'update', 'patch', 'remove'];
const createClient = (connection) => {
    ...
    client.use('shipday', connection.service('shipday'), {
        methods: shipdayServiceMethods
    });
    return client;
};
