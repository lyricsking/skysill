...
export declare const shipdayDataSchema: import("@sinclair/typebox").TPick<import("@sinclair/typebox").TObject<{
    id: import("@sinclair/typebox").TNumber;
    text: import("@sinclair/typebox").TString<string>;
}>, ["text"]>;
export type ShipdayData = Static<typeof shipdayDataSchema>;
export declare const shipdayDataValidator: import("@feathersjs/schema").DataValidatorMap;
...
export declare const shipdayQuerySchema: import("@sinclair/typebox").TIntersect<[import("@sinclair/typebox").TPartial<import("@sinclair/typebox").TObject<{
