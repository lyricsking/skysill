...
export declare const shipdayDriverSchema: import("@sinclair/typebox").TObject<{
    id: import("@sinclair/typebox").TNumber;
    text: import("@sinclair/typebox").TString<string>;
}>;
export type ShipdayDriver = Static<typeof shipdayDriverSchema>;
export declare const shipdayDriverResolver: import("@feathersjs/schema").Resolver<{
    id: number;
    text: string;
}, HookContext<any>>;
export declare const shipdayDriverExternalResolver: import("@feathersjs/schema").Resolver<{
    id: number;
    text: string;
}, HookContext<any>>;
export declare const shipdayDriverDataSchema: import("@sinclair/typebox").TPick<import("@sinclair/typebox").TObject<{
    id: import("@sinclair/typebox").TNumber;
    text: import("@sinclair/typebox").TString<string>;
}>, ["text"]>;
export type ShipdayDriverData = Static<typeof shipdayDriverDataSchema>;
export declare const shipdayDriverDataValidator: import("@feathersjs/schema").DataValidatorMap;
export declare const shipdayDriverDataResolver: import("@feathersjs/schema").Resolver<{
    id: number;
    text: string;
}, HookContext<any>>;
export declare const shipdayDriverQueryProperties: import("@sinclair/typebox").TPick<import("@sinclair/typebox").TObject<{
    id: import("@sinclair/typebox").TNumber;
    text: import("@sinclair/typebox").TString<string>;
}>, ["id", "text"]>;
export declare const shipdayDriverQuerySchema: import("@sinclair/typebox").TIntersect<[import("@sinclair/typebox").TPartial<import("@sinclair/typebox").TObject<{
...
export declare const shipdayDriverQueryValidator: import("@feathersjs/schema").Validator<any, any>;
export declare const shipdayDriverQueryResolver: import("@feathersjs/schema").Resolver<Partial<{
    $limit: number;
    $skip: number;
    $sort: {
        id?: number | undefined;
