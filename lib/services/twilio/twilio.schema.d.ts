...
export declare type Twilio = Static<typeof twilioSchema>;
...
export declare type TwilioData = Static<typeof twilioDataSchema>;
...
export declare const twilioQuerySchema: import("@sinclair/typebox").TIntersect<[import("@sinclair/typebox").TObject<{
...
export declare type TwilioQuery = Static<typeof twilioQuerySchema>;
export declare const twilioQueryValidator: import("@feathersjs/schema").Validator<any, any>;
export declare const twilioQueryResolver: import("@feathersjs/schema").Resolver<{
