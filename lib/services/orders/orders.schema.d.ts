...
export declare const ordersSchema: import("@sinclair/typebox").TObject<{
    ...
    deliveryAddress: import("@sinclair/typebox").TString<string>;
    deliveryGeopoint: import("@sinclair/typebox").TString<string>;
}>;
export declare type Orders = Static<typeof ordersSchema>;
...
export declare const ordersDataSchema: import("@sinclair/typebox").TOmit<import("@sinclair/typebox").TObject<{
    id: import("@sinclair/typebox").TNumber;
    shopId: import("@sinclair/typebox").TString<string>;
    shopperId: import("@sinclair/typebox").TString<string>;
    subtotal: import("@sinclair/typebox").TNumber;
...
export declare type OrdersData = Static<typeof ordersDataSchema>;
export declare const ordersDataValidator: import("@feathersjs/schema").DataValidatorMap;
...
export declare const ordersQueryProperties: import("@sinclair/typebox").TOmit<import("@sinclair/typebox").TObject<{
    id: import("@sinclair/typebox").TNumber;
    shopId: import("@sinclair/typebox").TString<string>;
    shopperId: import("@sinclair/typebox").TString<string>;
    subtotal: import("@sinclair/typebox").TNumber;
...
export declare const ordersQuerySchema: import("@sinclair/typebox").TIntersect<[import("@sinclair/typebox").TObject<{
    ...
    $select: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TUnsafe<("id" | "shopId" | "shopperId" | "subtotal" | "deliveryFee" | "deliveryAddress" | "deliveryGeopoint")[]>>;
    ...
    shopperId: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TUnion<[import("@sinclair/typebox").TString<string>, import("@sinclair/typebox").TObject<{
        $gt: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TString<string>>;
        $gte: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TString<string>>;
        $lt: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TString<string>>;
        $lte: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TString<string>>;
    ...
    subtotal: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TUnion<[import("@sinclair/typebox").TNumber, import("@sinclair/typebox").TObject<{
        $gt: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TNumber>;
        $gte: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TNumber>;
        $lt: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TNumber>;
        $lte: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TNumber>;
    ...
    deliveryFee: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TUnion<[import("@sinclair/typebox").TNumber, import("@sinclair/typebox").TObject<{
        $gt: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TNumber>;
        $gte: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TNumber>;
        $lt: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TNumber>;
        $lte: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TNumber>;
    ...
    deliveryAddress: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TUnion<[import("@sinclair/typebox").TString<string>, import("@sinclair/typebox").TObject<{
        $gt: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TString<string>>;
        $gte: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TString<string>>;
        $lt: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TString<string>>;
        $lte: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TString<string>>;
    ...
    deliveryGeopoint: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TUnion<[import("@sinclair/typebox").TString<string>, import("@sinclair/typebox").TObject<{
        $gt: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TString<string>>;
        $gte: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TString<string>>;
        $lt: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TString<string>>;
        $lte: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TString<string>>;
...
export declare type OrdersQuery = Static<typeof ordersQuerySchema>;
export declare const ordersQueryValidator: import("@feathersjs/schema").Validator<any, any>;
export declare const ordersQueryResolver: import("@feathersjs/schema").Resolver<{
    ...
    $select?: ("id" | "shopId" | "shopperId" | "subtotal" | "deliveryFee" | "deliveryAddress" | "deliveryGeopoint")[] | undefined;
} & {
    id?: number | {
        $gt?: number | undefined;
