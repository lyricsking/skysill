...
exports.productQueryResolver = exports.productQueryValidator = exports.productQuerySchema = exports.productQueryProperties = exports.productDataResolver = exports.productDataValidator = exports.productDataSchema = exports.productExternalResolver = exports.productResolver = exports.productSchema = exports.DiscountType = void 0;
...
exports.productSchema = typebox_1.Type.Object({
    ...
    discountType: (0, typebox_1.StringEnum)(Object.values(exports.DiscountType)),
...
exports.productQueryProperties = typebox_1.Type.Omit(exports.productSchema, ['productModifiers', 'discountType'], {
    additionalProperties: false
});
