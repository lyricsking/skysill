...
export declare const modifierOptionQuerySchema: import("@sinclair/typebox").TIntersect<[import("@sinclair/typebox").TPartial<import("@sinclair/typebox").TObject<{
    ...
    $select: import("@sinclair/typebox").TUnsafe<("id" | "name" | "price" | "modifierId")[]>;
...
export declare const modifierOptionQueryResolver: import("@feathersjs/schema").Resolver<Partial<{
    $limit: number;
    $skip: number;
    $sort: {
        id?: number | undefined;
    ...
    $select: ("id" | "name" | "price" | "modifierId")[];
    $or: {
        id?: number | Partial<{
            $gt: number;
            $gte: number;
