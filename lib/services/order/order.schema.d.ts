...
export declare type Order = Static<typeof orderSchema>;
...
export declare type OrderData = Static<typeof orderDataSchema>;
...
export declare const orderQuerySchema: import("@sinclair/typebox").TIntersect<[import("@sinclair/typebox").TObject<{
...
export declare type OrderQuery = Static<typeof orderQuerySchema>;
export declare const orderQueryValidator: import("@feathersjs/schema").Validator<any, any>;
export declare const orderQueryResolver: import("@feathersjs/schema").Resolver<{
