...
exports.orderQueryResolver = exports.orderQueryValidator = exports.orderQuerySchema = exports.orderQueryProperties = exports.orderDataResolver = exports.orderDataValidator = exports.orderDataSchema = exports.orderExternalResolver = exports.orderResolver = exports.orderSchema = exports.OrderStatus = void 0;
...
exports.orderSchema = typebox_1.Type.Object({
    ...
    isCart: typebox_1.Type.Optional(typebox_1.Type.Boolean()),
    orderStatus: typebox_1.Type.Optional(typebox_1.Type.Enum(OrderStatus)),
...
exports.orderDataSchema = typebox_1.Type.Omit(exports.orderSchema, ['id', 'subtotal', 'deliveryFee', 'deliveryAddress', 'deliveryGeopoint', 'lineItems'], {
    $id: 'OrderData',
