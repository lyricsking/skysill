...
const user = (app) => {
    ...
    app.service('users').hooks({
        ...
        before: {
            ...
            create: [(0, generate_id_1.generateId)(16)]
        },
        after: {
            all: [schema_1.hooks.resolveResult(users_schema_1.userResolver), schema_1.hooks.resolveExternal(users_schema_1.userExternalResolver)],
