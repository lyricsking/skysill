...
export declare const sampleSchema: import("@sinclair/typebox").TObject<{
    id: import("@sinclair/typebox").TNumber;
    text: import("@sinclair/typebox").TString<string>;
}>;
export declare type Sample = Static<typeof sampleSchema>;
export declare const sampleResolver: import("@feathersjs/schema").Resolver<{
    id: number;
    text: string;
}, HookContext<any>>;
export declare const sampleExternalResolver: import("@feathersjs/schema").Resolver<{
    id: number;
    text: string;
}, HookContext<any>>;
export declare const sampleDataSchema: import("@sinclair/typebox").TPick<import("@sinclair/typebox").TObject<{
    id: import("@sinclair/typebox").TNumber;
    text: import("@sinclair/typebox").TString<string>;
}>, ["text"]>;
export declare type SampleData = Static<typeof sampleDataSchema>;
export declare const sampleDataValidator: import("@feathersjs/schema").DataValidatorMap;
export declare const sampleDataResolver: import("@feathersjs/schema").Resolver<{
    id: number;
    text: string;
}, HookContext<any>>;
export declare const sampleQueryProperties: import("@sinclair/typebox").TPick<import("@sinclair/typebox").TObject<{
    id: import("@sinclair/typebox").TNumber;
    text: import("@sinclair/typebox").TString<string>;
}>, ["id", "text"]>;
export declare const sampleQuerySchema: import("@sinclair/typebox").TIntersect<[import("@sinclair/typebox").TObject<{
...
export declare type SampleQuery = Static<typeof sampleQuerySchema>;
export declare const sampleQueryValidator: import("@feathersjs/schema").Validator<any, any>;
export declare const sampleQueryResolver: import("@feathersjs/schema").Resolver<{
