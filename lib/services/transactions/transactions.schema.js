...
exports.transactionsDataSchema = typebox_1.Type.Pick(exports.transactionsSchema, ['text'], {
    $id: 'TransactionsData',
...
exports.transactionsQueryProperties = typebox_1.Type.Pick(exports.transactionsSchema, ['id', 'text'], {
    additionalProperties: false
});
