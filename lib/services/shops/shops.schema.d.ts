...
export declare const shopsSchema: import("@sinclair/typebox").TObject<{
...
export declare type Shops = Static<typeof shopsSchema>;
export declare const shopsResolver: import("@feathersjs/schema").Resolver<{
    id: number;
    description: string;
    businessId: string;
    coordinate: string;
}, HookContext<any>>;
export declare const shopsExternalResolver: import("@feathersjs/schema").Resolver<{
    id: number;
    description: string;
    businessId: string;
    coordinate: string;
}, HookContext<any>>;
export declare const shopsDataSchema: import("@sinclair/typebox").TOmit<import("@sinclair/typebox").TObject<{
    id: import("@sinclair/typebox").TNumber;
    businessId: import("@sinclair/typebox").TString<string>;
    description: import("@sinclair/typebox").TString<string>;
    coordinate: import("@sinclair/typebox").TString<string>;
}>, ["id"]>;
export declare type ShopsData = Static<typeof shopsDataSchema>;
export declare const shopsDataValidator: import("@feathersjs/schema").DataValidatorMap;
export declare const shopsDataResolver: import("@feathersjs/schema").Resolver<{
    id: number;
    description: string;
    businessId: string;
    coordinate: string;
}, HookContext<any>>;
export declare const shopsQueryProperties: import("@sinclair/typebox").TOmit<import("@sinclair/typebox").TObject<{
    id: import("@sinclair/typebox").TNumber;
    businessId: import("@sinclair/typebox").TString<string>;
    description: import("@sinclair/typebox").TString<string>;
    coordinate: import("@sinclair/typebox").TString<string>;
}>, []>;
export declare const shopsQuerySchema: import("@sinclair/typebox").TIntersect<[import("@sinclair/typebox").TObject<{
    ...
    $select: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TUnsafe<("id" | "description" | "businessId" | "coordinate")[]>>;
...
export declare type ShopsQuery = Static<typeof shopsQuerySchema>;
export declare const shopsQueryValidator: import("@feathersjs/schema").Validator<any, any>;
export declare const shopsQueryResolver: import("@feathersjs/schema").Resolver<{
    ...
    $select?: ("id" | "description" | "businessId" | "coordinate")[] | undefined;
} & {
    id?: number | {
        $gt?: number | undefined;
