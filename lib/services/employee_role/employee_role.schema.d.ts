...
export declare type EmployeeRole = Static<typeof employeeRoleSchema>;
...
export declare type EmployeeRoleData = Static<typeof employeeRoleDataSchema>;
...
export declare const employeeRoleQuerySchema: import("@sinclair/typebox").TIntersect<[import("@sinclair/typebox").TObject<{
...
export declare type EmployeeRoleQuery = Static<typeof employeeRoleQuerySchema>;
export declare const employeeRoleQueryValidator: import("@feathersjs/schema").Validator<any, any>;
export declare const employeeRoleQueryResolver: import("@feathersjs/schema").Resolver<{
