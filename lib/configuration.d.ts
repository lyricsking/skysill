...
export declare const configurationSchema: import("@feathersjs/schema").SchemaWrapper<{
    readonly $id: "ApplicationConfiguration";
    readonly type: "object";
    readonly additionalProperties: false;
    readonly required: readonly ["host", "port", "public", "paginate"];
    readonly properties: {
        readonly host: {
