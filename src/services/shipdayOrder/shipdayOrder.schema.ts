...
export const shipdayOrderPatchResolver = resolve<ShipdayOrder, HookContext>({})

// Schema for allowed query properties
export const shipdayOrderQueryProperties = Type.Pick(shipdayOrderSchema, [])
export const shipdayOrderQuerySchema = Type.Intersect(
  [
    querySyntax(shipdayOrderQueryProperties),
