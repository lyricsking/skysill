...
import {
  ...
  productModifierPatchValidator,
  productModifierQueryValidator,
  productModifierResolver,
  productModifierExternalResolver,
  productModifierDataResolver,
  productModifierPatchResolver,
  productModifierQueryResolver
} from './productModifier.schema'

import type { Application } from '../../declarations'
import { ProductModifierService, getOptions } from './productModifier.class'

export * from './productModifier.class'
export * from './productModifier.schema'
...
export const productModifier = (app: Application) => {
  ...
  app.service('productModifier').hooks({
    ...
    before: {
      ...
      patch: [
        schemaHooks.validateData(productModifierPatchValidator),
        schemaHooks.resolveData(productModifierPatchResolver)
      ],
      remove: []
    },
    after: {
